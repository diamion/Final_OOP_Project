...
public class Main extends Application {
    ...
    private void intMainmenu(Stage primaryStage){
        ...
        Button PvBotButton = createButton("file:demo/src/main/resources/pvbot_button.png");
        Button btnPlay = createButton("file:demo/src/main/resources/play_button.png");
       
        Button PuzzleButton = createButton("file:demo/src/main/resources/puzzle_button.png");
       
       
       Image backgroundImage = new Image("file:demo/src/main/resources/background/background.png");
